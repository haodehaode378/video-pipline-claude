...
### 阴影
```
小:   shadow-[2px_2px_0_#000]
中:   shadow-[4px_4px_0_#000]
大:   shadow-[6px_6px_0_#000]
悬停: shadow-[6px_6px_0_#000]
聚焦: shadow-[4px_4px_0_#ff69b4]
```
...
```html
<button class="px-6 py-3 border-4 border-black rounded-lg font-black uppercase tracking-wider shadow-[4px_4px_0_#000] transition-all duration-150 bg-[#ff006e] text-white px-4 py-2 md:px-6 md:py-3">
  点击我
</button>
```
...
<div class="bg-white border-4 border-black rounded-lg shadow-[6px_6px_0_#000] p-6">
  <h3 class="font-black uppercase text-2xl md:text-3xl">标题</h3>
</div>
```
...
```html
<input class="bg-white border-4 border-black rounded-lg text-black font-bold focus:border-[#ff69b4] focus:shadow-[4px_4px_0_#ff69b4] px-3 py-2 md:px-4 md:py-3" placeholder="请输入..." />
```
...
```
Create a gallery page using Pop Art style:
...
生成 波普艺术风格的 SaaS 产品着陆页

```
Create a SaaS landing page using Pop Art style with hero section, feature grid, testimonials, pricing table, and footer.
```
...
```
Create a portfolio showcase page using Pop Art style with project grid, about section, contact form, and consistent visual language.
```