...
### 阴影
```
小:   shadow-[0_0_8px_rgba(181,166,66,0.2)]
中:   shadow-[0_0_15px_rgba(181,166,66,0.3)]
大:   shadow-[0_0_25px_rgba(181,166,66,0.4)]
悬停: shadow-[0_0_20px_rgba(184,115,51,0.4)]
聚焦: shadow-[0_0_12px_rgba(181,166,66,0.25)]
```
...
```html
<button class="px-6 py-3 rounded font-serif uppercase tracking-wider transition-all duration-300 bg-[#ff006e] text-white px-4 py-2 md:px-6 md:py-3">
  点击我
</button>
```
...
<div class="bg-[#2a1f15] border-2 border-[#b87333]/40 rounded p-6">
  <h3 class="font-serif font-bold text-xl md:text-2xl">标题</h3>
</div>
```
...
```html
<input class="bg-[#2a1f15] border-2 border-[#b87333]/30 rounded text-[#f5f0e1] font-serif focus:border-[#b5a642] focus:shadow-[0_0_12px_rgba(181,166,66,0.25)] px-3 py-2 md:px-4 md:py-3" placeholder="请输入..." />
```
...
```
Create a dashboard interface using Steampunk style:
...
生成 蒸汽朋克风格的 SaaS 产品着陆页

```
Create a SaaS landing page using Steampunk style with hero section, feature grid, testimonials, pricing table, and footer.
```
...
```
Create a portfolio showcase page using Steampunk style with project grid, about section, contact form, and consistent visual language.
```