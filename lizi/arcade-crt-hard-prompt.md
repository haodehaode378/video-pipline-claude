...
```html
<button class="font-mono uppercase tracking-[0.2em] border-2 transition-all duration-200 bg-[#ff006e] text-white px-4 py-2 md:px-6 md:py-3">
  点击我
</button>
```
...
<div class="bg-[#0a0a0a] border-2 p-6">
  <h3 class="font-mono font-bold uppercase tracking-[0.15em] text-xl md:text-2xl">标题</h3>
</div>
```
...
```html
<input class="bg-black border-2 text-[#39ff14] font-mono focus:border-[#39ff14] focus:shadow-[0_0_15px_rgba(57,255,20,0.3)] px-3 py-2 md:px-4 md:py-3" placeholder="请输入..." />
```
